...
class LiftSplatShootFDAL(nn.Module):
    def __init__(self, grid_conf, data_aug_conf, outC = 1): # num classes 1 for BCE 
        ...
        # data_aug_conf are different for nuscenes and carla
        # therefore default set to None
        # only final_dims (128, 352) are used (same for both)
        #
    ...
    def create_frustum(self):
        ...
        # data_aug_conf is set to None, final_dim are same (128, 352)

        if self.data_aug_conf==None:
            ogfH, ogfW = (128, 352)
        else:
    ...
    def get_geometry(self, rots, trans, intrins, post_rots, post_trans):
        ...
        #print(post_trans.shape,'post trans shape')
